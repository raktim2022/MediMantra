            ...
            <form onSubmit={handleSubmit}>
              ...
              <div>
                <button
                  ...
                  className={`w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 transition duration-300 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                >
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <p className="text-lg font-medium text-gray-900">Office Address</p>
                    <p className="text-gray-600">123 MediTech Boulevard</p>
